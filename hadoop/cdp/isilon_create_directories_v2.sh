...
case "$DIST" in
    ...
    "hwx")
	    ...
	    "/ats/active#1777#yarn#hadoop" \
            ...
            "/mapred#755#mapred#hdfs" \
            "/mapred/system#755#mapred#hdfs" \
            "/user#755#hdfs#hdfs" \
            "/user/ambari-qa#770#ambari-qa#hdfs" \
            "/user/hcat#755#hcat#hdfs" \
            "/user/hdfs#755#hdfs#hdfs" \
	    "/user/hdfs/.staging#755#hdfs#hdfs" \
            "/user/hive#700#hive#hdfs" \
            "/user/hue#755#hue#hue" \
            "/user/oozie#775#oozie#hdfs" \
            "/user/yarn#755#yarn#hdfs" \
            "/system#755#yarn#hadoop" \
	    "/system/yarn#755#yarn#hadoop" \
            "/system/yarn/node-labels#700#yarn#hadoop" \
	    "/app-logs/yarn-ats#770#yarn-ats#hadoop" \
	    "/app-logs/yarn-ats/logs#770#yarn-ats#hadoop" \
	    "/atsv2#755#hdfs#hdfs" \
	    "/atsv2/hbase#755#hdfs#hdfs" \
	    "/atsv2/hbase/data#755#yarn-ats#hdfs" \
	    "/hdp#755#hdfs#hadoop" \
	    "/hdp/apps#755#hdfs#hadoop" \
	    "/mr-history#1777#mapred#hadoop" \
	    "/mr-history/done#777#mapred#hadoop" \
	    "/mr-history/tmp##777#mapred#hadoop" \
	    "/services#755#hdfs#hdfs" \
	    "/services/sync#755#hdfs#hdfs" \
	    "/services/sync/yarn-ats#755#yarn#hadoop" \
	    "/tmp/entity-file-history#755#yarn#hadoop" \
	    "/user/yarn-ats#775#yarn-ats#hadoop" \
        )
        ;;
    "bi")
        # Format is: dirname#perm#owner#group
